...
export const tsk_commands: CommandEntry[] = [
    ...
    { command: 'ffind', layer: 'fs', description: 'Finds allocated and unallocated file names that point to a given meta data structure.' },
    { command: 'fls', layer: 'fs', category: 'ls', description: 'Lists allocated and deleted file names in a directory.' },
    ...
    { command: 'mmls', layer: 'meta', category: 'ls', description: 'Displays the layout of a disk, including the unallocated spaces.' },
    { command: 'mmstat', layer: 'meta', category: 'stat', description: 'Display details about a volume system (typically only the type).' },
    { command: 'mmcat', layer: 'meta', category: 'cat', description: 'Extracts the contents of a specific volume.' },
